          ...
          <div className="lg:col-span-3">
            ...
            <div>
              ...
              <div className="sticky top-0 z-30">
                <div className="flex w-[109%] -ml-[5%] bg-[#66FFFF] overflow-hidden rounded-[6px] border-2 border-black divide-x divide-black h-8">
                  {tabs.map((tab) => (
                    <button
                      key={tab.key}
                      onClick={() => setActiveTab(tab.key)}
                      className={`flex-1 flex items-center justify-center whitespace-nowrap
          text-[14px] leading-none transition-all duration-200 h-full
          font-medium
          ${
            activeTab === tab.key
              ? "bg-[#002060] text-white font-medium"
              : "bg-[#66FFFF] text-black font-light"
          }
        `}
                    >
                      {tab.label}
              ...
              bg-clip-text text-transparent"
                            ...
                            <div className="flex flex-col items-start xl:items-end gap-2">
                              ...
                              {/* {isAgent && isActiveAgent && (
                                <Button
                                  className="rounded-xl px-6 h-10 text-white bg-green-600 hover:bg-green-700"
                                  onClick={() =>
  ...
  <div className="space-y-4">
    ...
    <div className="bg-[#0c2d67] p-2 rounded-2xl">
      <div className="bg-[#b9d3ea] p-2 rounded-2xl">
        ...
        {/* 🟡 CONTENT CARD */}
        <div className="grid md:grid-cols-2 gap-3 text-sm border border-black rounded-[10px] p-3 bg-[#FFE1E1]">
          ...
          <p>
            <strong>Category:</strong> {data?.property?.category}
          </p>
            ...
            <strong>City:</strong> {data?.property?.city}
                                  ...
                                  <table className="w-full border bg-[#FFEBEE] border-gray-400 text-sm text-center">
                                    ...
                                    <thead>
                                      ...
                                      <tr className="bg-yellow-600 text-white">
                                        ...
                                        <th className="border px-2 py-2">EP</th>
                                        <th className="border px-2 py-2">
                                          CPAI
                                        </th>
                                        <th className="border px-2 py-2">
                                        ...
                                        <th className="border px-2 py-2 text-xs">
                                          Ex. Person
                                        </th>
                                        <th className="border px-2 py-2 text-xs">
                                          Child (With Bed)
                ...
                {activeTab === "staff" && data?.staff?.length > 0 && (
                  <>
                    ...
                    {/* Outer */}
                    <div className="bg-[#2f5597] p-2 rounded-[14px]">
                      <div className="bg-[#f8e4e4] rounded-[12px] px-3 pb-3">
                        {/* Header */}
                        <h2 className="bg-red-600 text-white text-center font-bold text-lg py-2 rounded-t-[10px] -mx-3 mb-3">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                          {filteredStaff.map((s: any) => {
                            ...
                            return (
                              <div
                                key={s.id}
                                className="bg-[#2f3e5c] p-1 rounded-[10px]"
                              >
                                <div className="">
                                  <div className="flex gap-2">
                                    {/* PHOTO */}
                                    {/* PHOTO */}
                                    <div className="w-[140px] h-[170px] bg-gray-300 flex items-center justify-center rounded-[10px] border-[3px] border-[#2f3e5c] overflow-hidden">
                                      {s.photo &&
                                    ...
                                    {/* DETAILS */}
                                    <div className="flex-1 space-y-[3px] text-[11px]">
                                      {/* NAME (2 fields) */}
                                      <div className="grid grid-cols-12 gap-1 items-center">
                                        <div className="col-span-3 bg-red-600 text-white px-2 h-[22px] flex items-center rounded">
                                          Name
                                        </div>
                                        ...
                                        <input
                                          ...
                                          readOnly
                                          placeholder="Name"
                                          className="col-span-4 bg-[#e8d3d3] px-2 h-[22px] rounded border border-black"
                                        />
                                        ...
                                        <input
                                          ...
                                          readOnly
                                          placeholder="SurName"
                                          className="col-span-5 bg-[#e8d3d3] px-2 h-[22px] rounded border border-black"
                                        />
                                      </div>

                                      {/* OTHER ROWS */}
                                      {[
                                        { label: "Post", value: s.designation },
                                        {
                                          label: "Cell 1",
                                          value: phones[0] || "",
                                        },
                                        ...
                                        >
                                          ...
                                          <input
                                            value={item.value}
                                            readOnly
                                            className="col-span-9 bg-[#e8d3d3] px-2 h-[22px] rounded border border-black"
                                          />
                                        </div>
                                      ))}
                                      ...
                                      <div className="grid grid-cols-12 gap-1 items-center">
                                        ...
                                        <div className="col-span-2 bg-red-600 text-white h-[22px] flex items-center justify-center rounded">
                                          Extn
                                        </div>
                                        ...
                                        <input
                                          value={s.extension || ""}
                                          readOnly
                                          className="col-span-2 bg-[#e8d3d3] px-2 h-[22px] rounded border border-black"
                                        />
                                      </div>
                                    </div>
                                  </div>
